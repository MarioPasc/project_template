...
\begin{figure}[htbp]
	...
	\caption{Representación de los procesos biológicos enriquecidos ordenados por p-valor ajustado.}
	\label{fig:bar_plot}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Relación entre Procesos Biológicos, Gene Ratio y Significancia en la DFT.}
	\label{fig:dot_plot}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Red de Interacción entre Genes y Procesos Biológicos en la DFT.}
	\label{fig:cnet_plot}
\end{figure}
